const struct CompressedSpritePalette gMonShinyPaletteTable[] =
{
    ...
    SPECIES_SHINY_PAL(MTYRANITAR, gMonShinyPalette_MTyranitar),
    ...
    SPECIES_SHINY_PAL(HZOROARK, gMonShinyPalette_Hzoroark),
    SPECIES_SHINY_PAL(HZORUA, gMonShinyPalette_Hzorua),
    ...
    SPECIES_SHINY_PAL(GROOKI, gMonShinyPalette_Grooki),
    ...
    SPECIES_SHINY_PAL(INDEEDEE1, gMonShinyPalette_Indeedee1),
    SPECIES_SHINY_PAL(INDEEDEE2, gMonShinyPalette_Indeedee2),
    ...
    SPECIES_SHINY_PAL(JIGGLYTUFF, gMonShinyPalette_Jigglytuff),
    SPECIES_SHINY_PAL(CLODSIRE, gMonShinyPalette_Clodsire),
    SPECIES_SHINY_PAL(DACSHBUN, gMonShinyPalette_Dacshbun),
    SPECIES_SHINY_PAL(FIDOUGH, gMonShinyPalette_Fidough),
    SPECIES_SHINY_PAL(FUECOCO, gMonShinyPalette_Fuecoco),
    SPECIES_SHINY_PAL(GALVANADE, gMonShinyPalette_Galvanade),
    ...
    SPECIES_SHINY_PAL(ORICORIO1, gMonShinyPalette_Oricorio1),
    SPECIES_SHINY_PAL(ORICORIO2, gMonShinyPalette_Oricorio2),
    SPECIES_SHINY_PAL(ORICORIO3, gMonShinyPalette_Oricorio3),
    ...
    SPECIES_SHINY_PAL(VOLCRYPTID, gMonShinyPalette_Volcryptid),
    SPECIES_SHINY_PAL(BLUBBY, gMonShinyPalette_Blubby),
    SPECIES_SHINY_PAL(NAVI, gMonShinyPalette_Navi),
    ...
    SPECIES_SHINY_PAL(FROSSLASS, gMonShinyPalette_Frosslass),
    ...
    SPECIES_SHINY_PAL(GOUGING, gMonShinyPalette_Gouging),
    SPECIES_SHINY_PAL(HANKAMO_O, gMonShinyPalette_Hankamo_O),
    ...
    SPECIES_SHINY_PAL(AMPHAROS2, gMonShinyPalette_Ampharos2),
    SPECIES_SHINY_PAL(SCIZOR2, gMonShinyPalette_Scizor2),
    SPECIES_SHINY_PAL(NICKIT, gMonShinyPalette_Nickit),
    SPECIES_SHINY_PAL(MEOWTH2, gMonShinyPalette_Meowth2),
    SPECIES_SHINY_PAL(NINETAILS2, gMonShinyPalette_Ninetails2),
    SPECIES_SHINY_PAL(PURRLOIN, gMonShinyPalette_Purrloin),
    SPECIES_SHINY_PAL(ROTOM1, gMonShinyPalette_Rotom1),
    SPECIES_SHINY_PAL(ROTOM2, gMonShinyPalette_Rotom2),
    SPECIES_SHINY_PAL(ROTOM3, gMonShinyPalette_Rotom3),
    SPECIES_SHINY_PAL(ROTOM4, gMonShinyPalette_Rotom4),
    SPECIES_SHINY_PAL(ROTOM5, gMonShinyPalette_Rotom5),
    SPECIES_SHINY_PAL(ROTOM6, gMonShinyPalette_Rotom6),
    SPECIES_SHINY_PAL(ANNIHILAPE, gMonShinyPalette_Annihilape),
    SPECIES_SHINY_PAL(ARCANINE2, gMonShinyPalette_Arcanine2),
    ...
    SPECIES_SHINY_PAL(HOOPA2, gMonShinyPalette_Hoopa2),
    ...
    SPECIES_SHINY_PAL(SANDSHREW1, gMonShinyPalette_Sandshrew1),
    SPECIES_SHINY_PAL(SANDSLASH1, gMonShinyPalette_Sandslash1),
    ...
    SPECIES_SHINY_PAL(TAUROS2, gMonShinyPalette_Tauros2),
    SPECIES_SHINY_PAL(TERRAKION, gMonShinyPalette_Terrakion),
    SPECIES_SHINY_PAL(THIEVUL, gMonShinyPalette_Thievul),
    SPECIES_SHINY_PAL(TOXTRICITY2, gMonShinyPalette_Toxtricity2),
    ...
    SPECIES_SHINY_PAL(URSALUNA2, gMonShinyPalette_Ursaluna2),
    ...
    SPECIES_SHINY_PAL(VULPIX1, gMonShinyPalette_Vulpix1),
    ...
    SPECIES_SHINY_PAL(ELEBABY, gMonShinyPalette_Elebaby),
    SPECIES_SHINY_PAL(ZAPDOS2, gMonShinyPalette_Zapdos2),
    SPECIES_SHINY_PAL(KONYA, gMonShinyPalette_Konya),
    ...
    SPECIES_SHINY_PAL(CORSOLA2, gMonShinyPalette_Corsola2),
    ...
    SPECIES_SHINY_PAL(LILLIGANT2, gMonShinyPalette_Lilligant2),
    ...
    SPECIES_SHINY_PAL(DUGTRIO2, gMonShinyPalette_Dugtrio2),
    ...
    SPECIES_SHINY_PAL(LUGIA2, gMonShinyPalette_Lugia2),
    SPECIES_SHINY_PAL(NIHILEGO, gMonShinyPalette_Nihilego),
    SPECIES_SHINY_PAL(TOGEKISS, gMonShinyPalette_Togekiss),
    SPECIES_SHINY_PAL(TYPHLOSION2, gMonShinyPalette_Typhlosion2),
    SPECIES_SHINY_PAL(XURKITREE, gMonShinyPalette_Xurkitree),
    SPECIES_SHINY_PAL(DIALGA, gMonShinyPalette_Dialga),
    SPECIES_SHINY_PAL(ALTARIA2, gMonShinyPalette_Altaria2),
    SPECIES_SHINY_PAL(BLASTOISE2, gMonShinyPalette_Blastoise2),
    SPECIES_SHINY_PAL(SCEPTILE2, gMonShinyPalette_Sceptile2),
    SPECIES_SHINY_PAL(SWAMPERT2, gMonShinyPalette_Swampert2),
    SPECIES_SHINY_PAL(WALKINGWAKE, gMonShinyPalette_Walkingwake),
    SPECIES_SHINY_PAL(RAGINGBOLT, gMonShinyPalette_Ragingbolt),
    SPECIES_SHINY_PAL(ABSOL2, gMonShinyPalette_Absol2),
    SPECIES_SHINY_PAL(AGGRON2, gMonShinyPalette_Aggron2),
    SPECIES_SHINY_PAL(CHARIZARDY, gMonShinyPalette_Charizardy),
    SPECIES_SHINY_PAL(GARDEVOIR2, gMonShinyPalette_Gardevoir2),
    SPECIES_SHINY_PAL(HOUNDOOM2, gMonShinyPalette_Houndoom2),
    SPECIES_SHINY_PAL(LUCARIO2, gMonShinyPalette_Lucario2),
    SPECIES_SHINY_PAL(PIDGEOT2, gMonShinyPalette_Pidgeot2),
    SPECIES_SHINY_PAL(SABLEYE2, gMonShinyPalette_Sableye2),
    SPECIES_SHINY_PAL(SHARPEDO2, gMonShinyPalette_Sharpedo2),
    SPECIES_SHINY_PAL(PALKIA, gMonShinyPalette_Palkia),
    SPECIES_SHINY_PAL(PIPLUP2, gMonShinyPalette_Piplup2),
    SPECIES_SHINY_PAL(KONYA2, gMonShinyPalette_Konya2),
    SPECIES_SHINY_PAL(STUFFUL2, gMonShinyPalette_Stufful2),
    SPECIES_SHINY_PAL(LUNALA, gMonShinyPalette_Lunala),
    SPECIES_SHINY_PAL(BUTTERFREE2, gMonShinyPalette_Butterfree2),
    SPECIES_SHINY_PAL(DIANCIE2, gMonShinyPalette_Diancie2),
