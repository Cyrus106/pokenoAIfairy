const struct CompressedSpriteSheet gMonFrontPicTable[] =
{
    ...
    SPECIES_SPRITE(MTYRANITAR, gMonFrontPic_MTyranitar),
    ...
    SPECIES_SPRITE(HZOROARK, gMonFrontPic_Hzoroark),
    SPECIES_SPRITE(HZORUA, gMonFrontPic_Hzorua),
    ...
    SPECIES_SPRITE(GROOKI, gMonFrontPic_Grooki),
    ...
    SPECIES_SPRITE(INDEEDEE1, gMonFrontPic_Indeedee1),
    SPECIES_SPRITE(INDEEDEE2, gMonFrontPic_Indeedee2),
    ...
    SPECIES_SPRITE(JIGGLYTUFF, gMonFrontPic_Jigglytuff),
    SPECIES_SPRITE(CLODSIRE, gMonFrontPic_Clodsire),
    SPECIES_SPRITE(DACSHBUN, gMonFrontPic_Dacshbun),
    SPECIES_SPRITE(FIDOUGH, gMonFrontPic_Fidough),
    SPECIES_SPRITE(FUECOCO, gMonFrontPic_Fuecoco),
    SPECIES_SPRITE(GALVANADE, gMonFrontPic_Galvanade),
    ...
    SPECIES_SPRITE(ORICORIO1, gMonFrontPic_Oricorio1),
    SPECIES_SPRITE(ORICORIO2, gMonFrontPic_Oricorio2),
    SPECIES_SPRITE(ORICORIO3, gMonFrontPic_Oricorio3),
    ...
    SPECIES_SPRITE(VOLCRYPTID, gMonFrontPic_Volcryptid),
    SPECIES_SPRITE(BLUBBY, gMonFrontPic_Blubby),
    SPECIES_SPRITE(NAVI, gMonFrontPic_Navi),	
    ...
    SPECIES_SPRITE(FROSSLASS, gMonFrontPic_Frosslass),
    ...
    SPECIES_SPRITE(GOUGING, gMonFrontPic_Gouging),
    SPECIES_SPRITE(HANKAMO_O, gMonFrontPic_Hankamo_O),
    ...
    SPECIES_SPRITE(AMPHAROS2, gMonFrontPic_Ampharos2),
    SPECIES_SPRITE(SCIZOR2, gMonFrontPic_Scizor2),
    SPECIES_SPRITE(NICKIT, gMonFrontPic_Nickit),	
    SPECIES_SPRITE(MEOWTH2, gMonFrontPic_Meowth2),
    SPECIES_SPRITE(NINETAILS2, gMonFrontPic_Ninetails2),
    SPECIES_SPRITE(PURRLOIN, gMonFrontPic_Purrloin),
    SPECIES_SPRITE(ROTOM1, gMonFrontPic_Rotom1),
    SPECIES_SPRITE(ROTOM2, gMonFrontPic_Rotom2),
    SPECIES_SPRITE(ROTOM3, gMonFrontPic_Rotom3),
    SPECIES_SPRITE(ROTOM4, gMonFrontPic_Rotom4),
    SPECIES_SPRITE(ROTOM5, gMonFrontPic_Rotom5),
    SPECIES_SPRITE(ROTOM6, gMonFrontPic_Rotom6),	
    SPECIES_SPRITE(ANNIHILAPE, gMonFrontPic_Annihilape),
    SPECIES_SPRITE(ARCANINE2, gMonFrontPic_Arcanine2),
    ...
    SPECIES_SPRITE(HOOPA2, gMonFrontPic_Hoopa2),
    ...
    SPECIES_SPRITE(SANDSHREW1, gMonFrontPic_Sandshrew1),	
    SPECIES_SPRITE(SANDSLASH1, gMonFrontPic_Sandslash1),
    ...
    SPECIES_SPRITE(TAUROS2, gMonFrontPic_Tauros2),
    SPECIES_SPRITE(TERRAKION, gMonFrontPic_Terrakion),
    SPECIES_SPRITE(THIEVUL, gMonFrontPic_Thievul),
    SPECIES_SPRITE(TOXTRICITY2, gMonFrontPic_Toxtricity2),	
    ...
    SPECIES_SPRITE(URSALUNA2, gMonFrontPic_Ursaluna2),
    ...
    SPECIES_SPRITE(VULPIX1, gMonFrontPic_Vulpix1),
    ...
    SPECIES_SPRITE(ELEBABY, gMonFrontPic_Elebaby),
    SPECIES_SPRITE(ZAPDOS2, gMonFrontPic_Zapdos2),
    SPECIES_SPRITE(KONYA, gMonFrontPic_Konya),
    ...
    SPECIES_SPRITE(CORSOLA2, gMonFrontPic_Corsola2),
    ...
    SPECIES_SPRITE(LILLIGANT2, gMonFrontPic_Lilligant2),
    ...
    SPECIES_SPRITE(DUGTRIO2, gMonFrontPic_Dugtrio2),
    ...
    SPECIES_SPRITE(LUGIA2, gMonFrontPic_Lugia2),
    SPECIES_SPRITE(NIHILEGO, gMonFrontPic_Nihilego),
    SPECIES_SPRITE(TOGEKISS, gMonFrontPic_Togekiss),
    SPECIES_SPRITE(TYPHLOSION2, gMonFrontPic_Typhlosion2),
    SPECIES_SPRITE(XURKITREE, gMonFrontPic_Xurkitree),
    SPECIES_SPRITE(DIALGA, gMonFrontPic_Dialga),
    SPECIES_SPRITE(ALTARIA2, gMonFrontPic_Altaria2),
    SPECIES_SPRITE(BLASTOISE2, gMonFrontPic_Blastoise2),
    SPECIES_SPRITE(SCEPTILE2, gMonFrontPic_Sceptile2),
    SPECIES_SPRITE(SWAMPERT2, gMonFrontPic_Swampert2),
    SPECIES_SPRITE(WALKINGWAKE, gMonFrontPic_Walkingwake),
    SPECIES_SPRITE(RAGINGBOLT, gMonFrontPic_Ragingbolt),
    SPECIES_SPRITE(ABSOL2, gMonFrontPic_Absol2),
    SPECIES_SPRITE(AGGRON2, gMonFrontPic_Aggron2),
    SPECIES_SPRITE(CHARIZARDY, gMonFrontPic_Charizardy),
    SPECIES_SPRITE(GARDEVOIR2, gMonFrontPic_Gardevoir2),
    SPECIES_SPRITE(HOUNDOOM2, gMonFrontPic_Houndoom2),
    SPECIES_SPRITE(LUCARIO2, gMonFrontPic_Lucario2),
    SPECIES_SPRITE(PIDGEOT2, gMonFrontPic_Pidgeot2),
    SPECIES_SPRITE(SABLEYE2, gMonFrontPic_Sableye2),
    SPECIES_SPRITE(SHARPEDO2, gMonFrontPic_Sharpedo2),
    SPECIES_SPRITE(PALKIA, gMonFrontPic_Palkia),
    SPECIES_SPRITE(PIPLUP2, gMonFrontPic_Piplup2),
    SPECIES_SPRITE(KONYA2, gMonFrontPic_Konya2),
    SPECIES_SPRITE(STUFFUL2, gMonFrontPic_Stufful2),
    SPECIES_SPRITE(LUNALA, gMonFrontPic_Lunala),
    SPECIES_SPRITE(BUTTERFREE2, gMonFrontPic_Butterfree2),
    SPECIES_SPRITE(DIANCIE2, gMonFrontPic_Diancie2),
