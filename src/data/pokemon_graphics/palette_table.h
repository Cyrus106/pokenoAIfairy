const struct CompressedSpritePalette gMonPaletteTable[] =
{
    ...
    SPECIES_PAL(MTYRANITAR, gMonPalette_MTyranitar),
    ...
    SPECIES_PAL(HZOROARK, gMonPalette_Hzoroark),	
    SPECIES_PAL(HZORUA, gMonPalette_Hzorua),	
    ...
    SPECIES_PAL(GROOKI, gMonPalette_Grooki),
    ...
    SPECIES_PAL(INDEEDEE1, gMonPalette_Indeedee1),
    SPECIES_PAL(INDEEDEE2, gMonPalette_Indeedee2),
    ...
    SPECIES_PAL(JIGGLYTUFF, gMonPalette_Jigglytuff),
    SPECIES_PAL(CLODSIRE, gMonPalette_Clodsire),
    SPECIES_PAL(DACSHBUN, gMonPalette_Dacshbun),
    SPECIES_PAL(FIDOUGH, gMonPalette_Fidough),
    SPECIES_PAL(FUECOCO, gMonPalette_Fuecoco),
    SPECIES_PAL(GALVANADE, gMonPalette_Galvanade),
    ...
    SPECIES_PAL(ORICORIO1, gMonPalette_Oricorio1),
    SPECIES_PAL(ORICORIO2, gMonPalette_Oricorio2),
    SPECIES_PAL(ORICORIO3, gMonPalette_Oricorio3),
    ...
    SPECIES_PAL(VOLCRYPTID, gMonPalette_Volcryptid),
    SPECIES_PAL(BLUBBY, gMonPalette_Blubby),
    SPECIES_PAL(NAVI, gMonPalette_Navi),
    ...
    SPECIES_PAL(FROSSLASS, gMonPalette_Frosslass),
    SPECIES_PAL(GHOLDENGO, gMonPalette_Gholdengo),
    SPECIES_PAL(GOLETT, gMonPalette_Golett),
    SPECIES_PAL(GOLURK, gMonPalette_Golurk),
    SPECIES_PAL(GOUGING, gMonPalette_Gouging),
    SPECIES_PAL(HANKAMO_O, gMonPalette_Hankamo_O),
    ...
    SPECIES_PAL(AMPHAROS2, gMonPalette_Ampharos2),
    SPECIES_PAL(SCIZOR2, gMonPalette_Scizor2),
    SPECIES_PAL(NICKIT, gMonPalette_Nickit),
    SPECIES_PAL(MEOWTH2, gMonPalette_Meowth2),
    SPECIES_PAL(NINETAILS2, gMonPalette_Ninetails2),
    SPECIES_PAL(PURRLOIN, gMonPalette_Purrloin),
    SPECIES_PAL(ROTOM1, gMonPalette_Rotom1),
    SPECIES_PAL(ROTOM2, gMonPalette_Rotom2),
    SPECIES_PAL(ROTOM3, gMonPalette_Rotom3),
    SPECIES_PAL(ROTOM4, gMonPalette_Rotom4),
    SPECIES_PAL(ROTOM5, gMonPalette_Rotom5),
    SPECIES_PAL(ROTOM6, gMonPalette_Rotom6),
    SPECIES_PAL(ANNIHILAPE, gMonPalette_Annihilape),
    SPECIES_PAL(ARCANINE2, gMonPalette_Arcanine2),
    ...
    SPECIES_PAL(HOOPA2, gMonPalette_Hoopa2),
    ...
    SPECIES_PAL(SANDSHREW1, gMonPalette_Sandshrew1),
    SPECIES_PAL(SANDSLASH1, gMonPalette_Sandslash1),
    ...
    SPECIES_PAL(TAUROS2, gMonPalette_Tauros2),
    SPECIES_PAL(TERRAKION, gMonPalette_Terrakion),
    SPECIES_PAL(THIEVUL, gMonPalette_Thievul),
    SPECIES_PAL(TOXTRICITY2, gMonPalette_Toxtricity2),
    ...
    SPECIES_PAL(URSALUNA2, gMonPalette_Ursaluna2),
    ...
    SPECIES_PAL(VULPIX1, gMonPalette_Vulpix1),
    ...
    SPECIES_PAL(ELEBABY, gMonPalette_Elebaby),
    SPECIES_PAL(ZAPDOS2, gMonPalette_Zapdos2),
    SPECIES_PAL(KONYA, gMonPalette_Konya),
    ...
    SPECIES_PAL(CORSOLA2, gMonPalette_Corsola2),
    ...
    SPECIES_PAL(LILLIGANT2, gMonPalette_Lilligant2),
    ...
    SPECIES_PAL(DUGTRIO2, gMonPalette_Dugtrio2),
    ...
    SPECIES_PAL(LUGIA2, gMonPalette_Lugia2),
    SPECIES_PAL(NIHILEGO, gMonPalette_Nihilego),
    SPECIES_PAL(TOGEKISS, gMonPalette_Togekiss),
    SPECIES_PAL(TYPHLOSION2, gMonPalette_Typhlosion2),
    SPECIES_PAL(XURKITREE, gMonPalette_Xurkitree),
    SPECIES_PAL(DIALGA, gMonPalette_Dialga),
    SPECIES_PAL(ALTARIA2, gMonPalette_Altaria2),
    SPECIES_PAL(BLASTOISE2, gMonPalette_Blastoise2),
    SPECIES_PAL(SCEPTILE2, gMonPalette_Sceptile2),
    SPECIES_PAL(SWAMPERT2, gMonPalette_Swampert2),
    SPECIES_PAL(WALKINGWAKE, gMonPalette_Walkingwake),
    SPECIES_PAL(RAGINGBOLT, gMonPalette_Ragingbolt),
    SPECIES_PAL(ABSOL2, gMonPalette_Absol2),
    SPECIES_PAL(AGGRON2, gMonPalette_Aggron2),
    SPECIES_PAL(CHARIZARDY, gMonPalette_Charizardy),
    SPECIES_PAL(GARDEVOIR2, gMonPalette_Gardevoir2),
    SPECIES_PAL(HOUNDOOM2, gMonPalette_Houndoom2),
    SPECIES_PAL(LUCARIO2, gMonPalette_Lucario2),
    SPECIES_PAL(PIDGEOT2, gMonPalette_Pidgeot2),
