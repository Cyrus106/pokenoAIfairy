...
const struct BaseStats gBaseStats[] =
{
    ...
    [SPECIES_DITTO] =
    {
        .baseHP        = 96, //buffed ditto's health to make him a actually viable
        .baseAttack    = 48,
        .baseDefense   = 48,
        .baseSpeed     = 110,
        .baseSpAttack  = 48,
    ...
    [SPECIES_BRELOOM] =
    {
        ...
        .eggGroup1 = EGG_GROUP_FAIRY,
        .eggGroup2 = EGG_GROUP_GRASS,
        .abilities = {ABILITY_INSOMNIA, ABILITY_EFFECT_SPORE},
        .safariZoneFleeRate = 0,
        .bodyColor = BODY_COLOR_GREEN,
        .noFlip = FALSE,
    },
    ...
    //There should be a comma on all entries except the last one for pokemon base stats
    [SPECIES_BUNEARY] =
    {
        .baseHP        = 55,
        .baseAttack    = 66,
  ...
  [SPECIES_NINETAILS2] = 
    {
       ...
       .eggGroup1 = EGG_GROUP_MONSTER,
        .eggGroup2 = EGG_GROUP_MONSTER,
       .abilities = {ABILITY_REFRIGERATE, ABILITY_THICK_FAT},
       .safariZoneFleeRate = 0,
       .bodyColor = BODY_COLOR_PURPLE,
      .noFlip = FALSE,
},
