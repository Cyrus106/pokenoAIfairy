const struct Evolution gEvolutionTable[NUM_SPECIES][EVOS_PER_MON] =
{
    ...
    [SPECIES_PIDGEOT]  = {{EVO_LEVEL, 65, SPECIES_PIDGEOT2}},
    ...
    [SPECIES_VULPIX1]     = {{EVO_LEVEL, 35, SPECIES_NINETAILS2}},
    [SPECIES_JIGGLYPUFF] = {{EVO_ITEM, ITEM_MOON_STONE, SPECIES_WIGGLYTUFF}},
     [SPECIES_WIGGLYTUFF] = {{EVO_LEVEL, 57, SPECIES_JIGGLYTUFF}},
    ...
    [SPECIES_PERSIAN]    = {{EVO_LEVEL, 50, SPECIES_MEOWTH2}},
    ...
    [SPECIES_GENGAR]    = {{EVO_LEVEL, 72, SPECIES_GENGAR2}},
    ...
    [SPECIES_SCIZOR]     = {{EVO_LEVEL, 65, SPECIES_SCIZOR2}},
    ...
    [SPECIES_DRAGONAIR]  = {{EVO_LEVEL, 49, SPECIES_DRAGONITE}},
    ...
    [SPECIES_TOGETIC]     = {{EVO_LEVEL, 45, SPECIES_TOGEKISS}},
    ...
    [SPECIES_AMPHAROS]   = {{EVO_LEVEL, 55, SPECIES_AMPHAROS2}},
    ...
    [SPECIES_URSARING]  = {{EVO_LEVEL, 46, SPECIES_URSALUNA}},
    [SPECIES_URSALUNA]  = {{EVO_LEVEL, 60, SPECIES_URSALUNA2}},
    ...
    [SPECIES_HOUNDOUR]   = {{EVO_LEVEL, 24, SPECIES_HOUNDOOM}},
     [SPECIES_HOUNDOOM]   = {{EVO_LEVEL, 60, SPECIES_HOUNDOOM2}},
    [SPECIES_PHANPY]     = {{EVO_LEVEL, 25, SPECIES_DONPHAN}},
    [SPECIES_DONPHAN]    = {{EVO_ITEM, ITEM_KINGS_ROCK, SPECIES_GREATTUSK},
                            {EVO_ITEM, ITEM_METAL_COAT, SPECIES_IRONTREADS}},
    ...
    [SPECIES_TYRANITAR]  = {{EVO_LEVEL, 72, SPECIES_MTYRANITAR}},
    ...
    [SPECIES_SHARPEDO]   = {{EVO_LEVEL, 60, SPECIES_SHARPEDO2}},
    ...
    [SPECIES_AGGRON]     = {{EVO_LEVEL, 65, SPECIES_AGGRON2}},
    ...
    [SPECIES_GARDEVOIR]     = {{EVO_LEVEL, 60, SPECIES_GARDEVOIR2}},
    ...
    [SPECIES_HZORUA]     = {{EVO_LEVEL, 30, SPECIES_HZOROARK}},
    ...
    [SPECIES_COTTONEE]     = {{EVO_LEVEL, 38, SPECIES_WHIMSICOTT}},
    [SPECIES_MAGMAR]     = {{EVO_LEVEL, 55, SPECIES_MAGMORTAR}},
    [SPECIES_VAROOM]     = {{EVO_LEVEL, 40, SPECIES_REVAVROOM}},
    [SPECIES_SANDSHREW1]     = {{EVO_LEVEL, 22, SPECIES_SANDSLASH1}},
    ...
    [SPECIES_SINISTEA]     = {{EVO_LEVEL, 40, SPECIES_POLTEAGEIST}},
    [SPECIES_APPLIN]     = {{EVO_LEVEL, 55, SPECIES_APPLETUN}},
    ...
    [SPECIES_BLASTOISE]     = {{EVO_LEVEL, 72, SPECIES_BLASTOISE2}},
    [SPECIES_SCEPTILE]     = {{EVO_LEVEL, 72, SPECIES_SCEPTILE2}},
    [SPECIES_ALTARIA]     = {{EVO_LEVEL, 60, SPECIES_ALTARIA2}},
    [SPECIES_SWAMPERT]     = {{EVO_LEVEL, 72, SPECIES_SWAMPERT2}},
    [SPECIES_MAGNETON]     = {{EVO_ITEM, ITEM_THUNDER_STONE, SPECIES_MAGNEZONE}},
    [SPECIES_SABLEYE]     = {{EVO_LEVEL, 40, SPECIES_SABLEYE2}},
    [SPECIES_MURKROW]     = {{EVO_LEVEL, 25, SPECIES_HONCHKROW}},
    [SPECIES_GLIGAR]     = {{EVO_LEVEL, 35, SPECIES_GLISCOR}},
    [SPECIES_FARFETCHD]     = {{EVO_LEVEL, 55, SPECIES_SIRFETCH}},
};
