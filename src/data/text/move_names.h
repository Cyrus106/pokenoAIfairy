const u8 gMoveNames[MOVES_COUNT][MOVE_NAME_LENGTH + 1] =
{
    ...
    [MOVE_DIAMOND_STORM] = _("DIAM STORM"),
    [MOVE_DARK_PULSE] = _("DARK PULSE"),
    [MOVE_SACRED_SWORD] = _("SACRED SWORD"),
    [MOVE_GIGATON_HAMMER] = _("GIGA HAMMER"),
    ...
    [MOVE_PSYCHIC_FANGS] = _("PSYCH FANG"),
    ...
    [MOVE_CLANGING_SCALES] = _("CLANG SCALE"),
