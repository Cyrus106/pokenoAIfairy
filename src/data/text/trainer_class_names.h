const u8 gTrainerClassNames[][13] = {
    ...
    [TRAINER_CLASS_HIDEO] = _("SOLID SNAKE"),
    [TRAINER_CLASS_FOREIGN_SPY] = _("FOREIGN SPYS"),
    [TRAINER_CLASS_TYRANT] = _("TYRANT"),
    [TRAINER_CLASS_GRAV_MASTER] = _("GRAV MASTER"),
    [TRAINER_CLASS_SNAGGER] = _("SNAGGER"),
    [TRAINER_CLASS_SWEETHEART] = _("SWEETHEART"),
    [TRAINER_CLASS_REVENGEANCED] = _("REVENGEANCED"),
    [TRAINER_CLASS_MAKSIM] = _("GUY CALLED"),
};
