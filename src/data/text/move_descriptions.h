...
static const u8 sTailSlapDescription[] = _(
  "Slaps 2 to 5 times in a row\n"
    "to strike the foe.");

static const u8 sPopBombDescription[] = _(
  "Slaps 2 to 5 times in a row\n"
    "to strike the foe.");
...
static const u8 sGigatonHammerDescription[] = _(
    "Swings a huge hammer. Needs\n"
    "a recharge after use.");
...
static const u8 sNightDazeDescription[] = _(
   "Hurls darkness in the foe's face\n"
    "to reduce its accuracy.");
...
static const u8 sPhantomForceDescription[] = _(
   "Vanish the first turn and\n"
    "strikes next turn. Ignores Protect.");
...
const u8 *const gMoveDescriptionPointers[MOVES_COUNT - 1] =
{
    ...
    [MOVE_MOON_BLAST - 1] = sMoonBlastDescription,
    ...
    [MOVE_POP_BOMB - 1] = sPopBombDescription,
