const u8 gSpeciesNames[][POKEMON_NAME_LENGTH + 1] = {
    ...
    [SPECIES_HERDIER] = _("HERDIER"),	
   	[SPECIES_HZOROARK] = _("ZOROARK"),
    [SPECIES_HZORUA] = _("ZORUA"),
    ...
    [SPECIES_NINETAILS2] = _("NINETAILS"),
