...
static const u8 sText_PkmnPhan[] = _("{B_ATK_NAME_WITH_PREFIX} vanished!");
...
const u8 * const gBattleStringsTable[BATTLESTRINGS_COUNT - BATTLESTRINGS_TABLE_START] =
{
    ...
    [STRINGID_LINKLISTENERLOSE - BATTLESTRINGS_TABLE_START] = sText_PlayerLostAgainstLinkTrainer,
    [STRINGID_LINKLISTENERWIN - BATTLESTRINGS_TABLE_START] = sText_PlayerDefeatedLinkTrainer,
    [STRINGID_PKMNPHAN - BATTLESTRINGS_TABLE_START] = sText_PkmnPhan,
};
...
const u16 gFirstTurnOfTwoStringIds[] =
{
    ...
    [B_MSG_TURN1_PHAN]     = STRINGID_PKMNPHAN,
};
    ...
    case STRINGID_INTROMSG: // first battle msg
        if (gBattleTypeFlags & BATTLE_TYPE_TRAINER)
        {
            ...
            else
            {
                ...
                {
                    if(IsLinkMaster()) stringPtr = sText_Trainer1WantsToBattle;
                    else stringPtr = sText_LinkTrainerWantsToBattle;
                }
            }
        }
        else
