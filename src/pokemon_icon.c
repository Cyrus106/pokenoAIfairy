...
const u8 *const gMonIconTable[] =
{
    ...
    [SPECIES_MTYRANITAR] = gMonIcon_MTyranitar,
    ...
    [SPECIES_HZOROARK] = gMonIcon_Hzoroark,
    [SPECIES_HZORUA] = gMonIcon_Hzorua,
    ...
    [SPECIES_GROOKI] = gMonIcon_Grooki,
    [SPECIES_HATENNA] = gMonIcon_Hatenna,
    [SPECIES_HATTERENE] = gMonIcon_Hatterene,
    [SPECIES_HATTREM] = gMonIcon_Hattrem,
    [SPECIES_INDEEDEE1] = gMonIcon_Indeedee1,
    [SPECIES_INDEEDEE2] = gMonIcon_Indeedee2,
    ...
    [SPECIES_FROSSLASS] = gMonIcon_Frosslass,
    [SPECIES_GHOLDENGO] = gMonIcon_Gholdengo,
    [SPECIES_GOLETT] = gMonIcon_Golett,
    [SPECIES_GOLURK] = gMonIcon_Golurk,
    [SPECIES_GOUGING] = gMonIcon_Gouging,
    [SPECIES_HANKAMO_O] = gMonIcon_Hankamo_O,
    ...
    [SPECIES_AMPHAROS2] = gMonIcon_Ampharos2,
    [SPECIES_SCIZOR2] = gMonIcon_Scizor2,
    [SPECIES_NICKIT] = gMonIcon_Nickit,
    [SPECIES_MEOWTH2] = gMonIcon_Meowth2,
    [SPECIES_NINETAILS2] = gMonIcon_Ninetails2,
    [SPECIES_PURRLOIN] = gMonIcon_Purrloin,
    [SPECIES_ROTOM1] = gMonIcon_Rotom1,
    [SPECIES_ROTOM2] = gMonIcon_Rotom2,
    [SPECIES_ROTOM3] = gMonIcon_Rotom3,
    [SPECIES_ROTOM4] = gMonIcon_Rotom4,
    [SPECIES_ROTOM5] = gMonIcon_Rotom5,
    [SPECIES_ROTOM6] = gMonIcon_Rotom6,
    [SPECIES_ANNIHILAPE] = gMonIcon_Annihilape,
    [SPECIES_ARCANINE2] = gMonIcon_Arcanine2,
    ...
    [SPECIES_HOOPA2] = gMonIcon_Hoopa2,
    ...
    [SPECIES_SANDSHREW1] = gMonIcon_Sandshrew1,
    [SPECIES_SANDSLASH1] = gMonIcon_Sandslash1,
    ...
    [SPECIES_TAUROS2] = gMonIcon_Tauros2,
    [SPECIES_TERRAKION] = gMonIcon_Terrakion,
    [SPECIES_THIEVUL] = gMonIcon_Thievul,
    [SPECIES_TOXTRICITY2] = gMonIcon_Toxtricity2,
    ...
    [SPECIES_URSALUNA2] = gMonIcon_Ursaluna2,
    ...
    [SPECIES_VULPIX1] = gMonIcon_Vulpix1,
    ...
    [SPECIES_ELEBABY] = gMonIcon_Elebaby,
    [SPECIES_ZAPDOS2] = gMonIcon_Zapdos2,
    [SPECIES_KONYA] = gMonIcon_Konya,
    ...
    [SPECIES_CORSOLA2] = gMonIcon_Corsola2,
    ...
    [SPECIES_LILLIGANT2] = gMonIcon_Lilligant2,
    ...
    [SPECIES_DUGTRIO2] = gMonIcon_Dugtrio2,
    ...
    [SPECIES_LUGIA2] = gMonIcon_Lugia2,
    ...
    [SPECIES_ABSOL2] = gMonIcon_Absol2,
    [SPECIES_AGGRON2] = gMonIcon_Aggron2,
    [SPECIES_CHARIZARDY] = gMonIcon_Charizardy,
    [SPECIES_GARDEVOIR2] = gMonIcon_Gardevoir2,
    [SPECIES_HOUNDOOM2] = gMonIcon_Houndoom2,
    [SPECIES_LUCARIO2] = gMonIcon_Lucario2,
...
const u8 gMonIconPaletteIndices[] =
{
    ...
    [SPECIES_SALANDIT] = 2,
    [SPECIES_SALAZZLE] = 0,
    [SPECIES_SANDSHREW1] = 0,
    [SPECIES_SANDSLASH1] = 0,
    [SPECIES_SANDYGAST] = 1,
    [SPECIES_SAWK] = 0,
    ...
    [SPECIES_AERODACTYL2] = 2,
    [SPECIES_ARCHALUDON] = 0,
    [SPECIES_CELESTEELA] = 0,
    [SPECIES_NECROZMADUSK] = 0,
    [SPECIES_REVAVROOM] = 0,
    [SPECIES_SOLGALEO] = 0,
    [SPECIES_VAROOM] = 2,
    [SPECIES_TOXICROAK] = 0,
    ...
    [SPECIES_ABSOL2] = 0,
    [SPECIES_AGGRON2] = 2,
    [SPECIES_CHARIZARDY] = 0,
    [SPECIES_GARDEVOIR2] = 1,
    [SPECIES_HOUNDOOM2] = 0,
    [SPECIES_LUCARIO2] = 2,
    [SPECIES_PIDGEOT2] = 0,
    [SPECIES_SABLEYE2] = 2,
