...
static const u16 sSpeciesToHoennPokedexNum[NUM_SPECIES - 1] =
{
    ...
    SPECIES_TO_HOENN(HZOROARK),
    SPECIES_TO_HOENN(HZORUA),
    ...
    SPECIES_TO_HOENN(FROSSLASS),
    SPECIES_TO_HOENN(GHOLDENGO),
    SPECIES_TO_HOENN(GOLETT),
    SPECIES_TO_HOENN(GOLURK),
    SPECIES_TO_HOENN(GOUGING),
    SPECIES_TO_HOENN(HANKAMO_O),
    ...
    SPECIES_TO_HOENN(AMPHAROS2),
    SPECIES_TO_HOENN(SCIZOR2),
    SPECIES_TO_HOENN(NICKIT),
    SPECIES_TO_HOENN(MEOWTH2),
    SPECIES_TO_HOENN(NINETAILS2),
    SPECIES_TO_HOENN(PURRLOIN),
    SPECIES_TO_HOENN(ROTOM1),
    SPECIES_TO_HOENN(ROTOM2),
    SPECIES_TO_HOENN(ROTOM3),
    SPECIES_TO_HOENN(ROTOM4),
    SPECIES_TO_HOENN(ROTOM5),
    SPECIES_TO_HOENN(ROTOM6),
    SPECIES_TO_HOENN(ANNIHILAPE),
    SPECIES_TO_HOENN(ARCANINE2),
    ...
    SPECIES_TO_HOENN(GENGAR2),
    SPECIES_TO_HOENN(VENUSAUR2),
    SPECIES_TO_HOENN(PECHARUNT),
    SPECIES_TO_HOENN(GOLEM2),
    SPECIES_TO_HOENN(IRONTHORNS),
    SPECIES_TO_HOENN(AERODACTYL2),
    SPECIES_TO_HOENN(ARCHALUDON),
    SPECIES_TO_HOENN(CELESTEELA),
    SPECIES_TO_HOENN(NECROZMADUSK),
    ...
    SPECIES_TO_HOENN(ELEBABY),
    SPECIES_TO_HOENN(ZAPDOS2),
    SPECIES_TO_HOENN(KONYA),
    ...
    SPECIES_TO_HOENN(LILLIGANT2),
    SPECIES_TO_HOENN(WYRDEER),
    SPECIES_TO_HOENN(MISMAGIUS),
    SPECIES_TO_HOENN(GOTHITELLE),
    SPECIES_TO_HOENN(AVALUGG),
    SPECIES_TO_HOENN(DUGTRIO2),
    SPECIES_TO_HOENN(BLACEPHALON),
    SPECIES_TO_HOENN(FERROSEED),
    SPECIES_TO_HOENN(FERROTHORN),
    SPECIES_TO_HOENN(GLISCOR),
    SPECIES_TO_HOENN(LUGIA2),
    SPECIES_TO_HOENN(NIHILEGO),
    SPECIES_TO_HOENN(TOGEKISS),
    SPECIES_TO_HOENN(TYPHLOSION2),
    SPECIES_TO_HOENN(XURKITREE),
    SPECIES_TO_HOENN(DIALGA),
    SPECIES_TO_HOENN(ALTARIA2),
    SPECIES_TO_HOENN(BLASTOISE2),
    SPECIES_TO_HOENN(SCEPTILE2),
    SPECIES_TO_HOENN(SWAMPERT2),
    SPECIES_TO_HOENN(WALKINGWAKE),
    SPECIES_TO_HOENN(RAGINGBOLT),
    SPECIES_TO_HOENN(ABSOL2),
    SPECIES_TO_HOENN(AGGRON2),
    SPECIES_TO_HOENN(CHARIZARDY),
    SPECIES_TO_HOENN(GARDEVOIR2),
    SPECIES_TO_HOENN(HOUNDOOM2),
    SPECIES_TO_HOENN(LUCARIO2),
    SPECIES_TO_HOENN(PIDGEOT2),
    SPECIES_TO_HOENN(SABLEYE2),
    SPECIES_TO_HOENN(SHARPEDO2),
    SPECIES_TO_HOENN(PALKIA),
    SPECIES_TO_HOENN(PIPLUP2),
    SPECIES_TO_HOENN(KONYA2),
    SPECIES_TO_HOENN(STUFFUL2),
    SPECIES_TO_HOENN(LUNALA),
    SPECIES_TO_HOENN(BUTTERFREE2),
    SPECIES_TO_HOENN(DIANCIE2),
};
...
static const u16 sSpeciesToNationalPokedexNum[NUM_SPECIES - 1] =
{
    ...
    SPECIES_TO_NATIONAL(MTYRANITAR),
    ...
    SPECIES_TO_NATIONAL(SHAYMINSKY),
    ...
    SPECIES_TO_NATIONAL(HZOROARK),
    SPECIES_TO_NATIONAL(HZORUA),
    ...
    SPECIES_TO_NATIONAL(GROOKI),
    SPECIES_TO_NATIONAL(HATENNA),
    SPECIES_TO_NATIONAL(HATTERENE),
    SPECIES_TO_NATIONAL(HATTREM),
    SPECIES_TO_NATIONAL(INDEEDEE1),
    SPECIES_TO_NATIONAL(INDEEDEE2),
    ...
    SPECIES_TO_NATIONAL(FROSSLASS),
    SPECIES_TO_NATIONAL(GHOLDENGO),
    SPECIES_TO_NATIONAL(GOLETT),
    SPECIES_TO_NATIONAL(GOLURK),
    SPECIES_TO_NATIONAL(GOUGING),
    SPECIES_TO_NATIONAL(HANKAMO_O),
    ...
    SPECIES_TO_NATIONAL(AMPHAROS2),
    SPECIES_TO_NATIONAL(SCIZOR2),
    SPECIES_TO_NATIONAL(NICKIT),
    SPECIES_TO_NATIONAL(MEOWTH2),
    SPECIES_TO_NATIONAL(NINETAILS2),
    SPECIES_TO_NATIONAL(PURRLOIN),
    SPECIES_TO_NATIONAL(ROTOM1),
    SPECIES_TO_NATIONAL(ROTOM2),
    SPECIES_TO_NATIONAL(ROTOM3),
    SPECIES_TO_NATIONAL(ROTOM4),
    SPECIES_TO_NATIONAL(ROTOM5),
    SPECIES_TO_NATIONAL(ROTOM6),
    SPECIES_TO_NATIONAL(ANNIHILAPE),
    SPECIES_TO_NATIONAL(ARCANINE2),
    ...
    SPECIES_TO_NATIONAL(GENGAR2),
    SPECIES_TO_NATIONAL(VENUSAUR2),
    SPECIES_TO_NATIONAL(PECHARUNT),
    SPECIES_TO_NATIONAL(GOLEM2),
    SPECIES_TO_NATIONAL(IRONTHORNS),
    SPECIES_TO_NATIONAL(AERODACTYL2),
    SPECIES_TO_NATIONAL(ARCHALUDON),
    SPECIES_TO_NATIONAL(CELESTEELA),
    SPECIES_TO_NATIONAL(NECROZMADUSK),
    ...
    SPECIES_TO_NATIONAL(ELEBABY),
    SPECIES_TO_NATIONAL(ZAPDOS2),
    SPECIES_TO_NATIONAL(KONYA),
    ...
    SPECIES_TO_NATIONAL(LILLIGANT2),
    SPECIES_TO_NATIONAL(WYRDEER),
    SPECIES_TO_NATIONAL(MISMAGIUS),
    SPECIES_TO_NATIONAL(GOTHITELLE),
    SPECIES_TO_NATIONAL(AVALUGG),
    SPECIES_TO_NATIONAL(DUGTRIO2),
    SPECIES_TO_NATIONAL(BLACEPHALON),
    SPECIES_TO_NATIONAL(FERROSEED),
    SPECIES_TO_NATIONAL(FERROTHORN),
    SPECIES_TO_NATIONAL(GLISCOR),
    SPECIES_TO_NATIONAL(LUGIA2),
    SPECIES_TO_NATIONAL(NIHILEGO),
    SPECIES_TO_NATIONAL(TOGEKISS),
    SPECIES_TO_NATIONAL(TYPHLOSION2),
    SPECIES_TO_NATIONAL(XURKITREE),
    SPECIES_TO_NATIONAL(DIALGA),
    SPECIES_TO_NATIONAL(ALTARIA2),
    SPECIES_TO_NATIONAL(BLASTOISE2),
    SPECIES_TO_NATIONAL(SCEPTILE2),
    SPECIES_TO_NATIONAL(SWAMPERT2),
    SPECIES_TO_NATIONAL(WALKINGWAKE),
    SPECIES_TO_NATIONAL(RAGINGBOLT),
    SPECIES_TO_NATIONAL(ABSOL2),
    SPECIES_TO_NATIONAL(AGGRON2),
    SPECIES_TO_NATIONAL(CHARIZARDY),
    SPECIES_TO_NATIONAL(GARDEVOIR2),
    SPECIES_TO_NATIONAL(HOUNDOOM2),
    SPECIES_TO_NATIONAL(LUCARIO2),
    SPECIES_TO_NATIONAL(PIDGEOT2),
    SPECIES_TO_NATIONAL(SABLEYE2),
    SPECIES_TO_NATIONAL(SHARPEDO2),
    SPECIES_TO_NATIONAL(PALKIA),
    SPECIES_TO_NATIONAL(PIPLUP2),
    SPECIES_TO_NATIONAL(KONYA2),
    SPECIES_TO_NATIONAL(STUFFUL2),
    SPECIES_TO_NATIONAL(LUNALA),
    SPECIES_TO_NATIONAL(BUTTERFREE2),
    SPECIES_TO_NATIONAL(DIANCIE2),
};
...
static const u16 sHoennToNationalOrder[NUM_SPECIES - 1] =
{
    ...
    HOENN_TO_NATIONAL(HZOROARK),
    HOENN_TO_NATIONAL(HZORUA),
    ...
    HOENN_TO_NATIONAL(GROOKI),
    HOENN_TO_NATIONAL(HATENNA),
    HOENN_TO_NATIONAL(HATTERENE),
    HOENN_TO_NATIONAL(HATTREM),
    HOENN_TO_NATIONAL(INDEEDEE1),
    HOENN_TO_NATIONAL(INDEEDEE2),
    ...
    HOENN_TO_NATIONAL(FROSSLASS),
    HOENN_TO_NATIONAL(GHOLDENGO),
    HOENN_TO_NATIONAL(GOLETT),
    HOENN_TO_NATIONAL(GOLURK),
    HOENN_TO_NATIONAL(GOUGING),
    HOENN_TO_NATIONAL(HANKAMO_O),
    ...
    HOENN_TO_NATIONAL(AMPHAROS2),
    HOENN_TO_NATIONAL(SCIZOR2),
    HOENN_TO_NATIONAL(NICKIT),
    HOENN_TO_NATIONAL(MEOWTH2),
    HOENN_TO_NATIONAL(NINETAILS2),
    HOENN_TO_NATIONAL(PURRLOIN),
    HOENN_TO_NATIONAL(ROTOM1),
    HOENN_TO_NATIONAL(ROTOM2),
    HOENN_TO_NATIONAL(ROTOM3),
    HOENN_TO_NATIONAL(ROTOM4),
    HOENN_TO_NATIONAL(ROTOM5),
    HOENN_TO_NATIONAL(ROTOM6),
    HOENN_TO_NATIONAL(ANNIHILAPE),
    HOENN_TO_NATIONAL(ARCANINE2),
    ...
    HOENN_TO_NATIONAL(GENGAR2),
    HOENN_TO_NATIONAL(VENUSAUR2),
    HOENN_TO_NATIONAL(PECHARUNT),
    HOENN_TO_NATIONAL(GOLEM2),
    HOENN_TO_NATIONAL(IRONTHORNS),
    HOENN_TO_NATIONAL(AERODACTYL2),
    HOENN_TO_NATIONAL(ARCHALUDON),
    HOENN_TO_NATIONAL(CELESTEELA),
    HOENN_TO_NATIONAL(NECROZMADUSK),
    ...
    HOENN_TO_NATIONAL(ELEBABY),
    HOENN_TO_NATIONAL(ZAPDOS2),
    HOENN_TO_NATIONAL(KONYA),
    ...
    HOENN_TO_NATIONAL(LILLIGANT2),
    HOENN_TO_NATIONAL(WYRDEER),
    HOENN_TO_NATIONAL(MISMAGIUS),
    HOENN_TO_NATIONAL(GOTHITELLE),
    HOENN_TO_NATIONAL(AVALUGG),
    HOENN_TO_NATIONAL(DUGTRIO2),
    HOENN_TO_NATIONAL(BLACEPHALON),
    HOENN_TO_NATIONAL(FERROSEED),
    HOENN_TO_NATIONAL(FERROTHORN),
    HOENN_TO_NATIONAL(GLISCOR),
    HOENN_TO_NATIONAL(LUGIA2),
    HOENN_TO_NATIONAL(NIHILEGO),
    HOENN_TO_NATIONAL(TOGEKISS),
    HOENN_TO_NATIONAL(TYPHLOSION2),
    HOENN_TO_NATIONAL(XURKITREE),
    HOENN_TO_NATIONAL(DIALGA),
    HOENN_TO_NATIONAL(ALTARIA2),
    HOENN_TO_NATIONAL(BLASTOISE2),
    HOENN_TO_NATIONAL(SCEPTILE2),
    HOENN_TO_NATIONAL(SWAMPERT2),
    HOENN_TO_NATIONAL(WALKINGWAKE),
    HOENN_TO_NATIONAL(RAGINGBOLT),
    HOENN_TO_NATIONAL(ABSOL2),
    HOENN_TO_NATIONAL(AGGRON2),
    HOENN_TO_NATIONAL(CHARIZARDY),
    HOENN_TO_NATIONAL(GARDEVOIR2),
    HOENN_TO_NATIONAL(HOUNDOOM2),
    HOENN_TO_NATIONAL(LUCARIO2),
    HOENN_TO_NATIONAL(PIDGEOT2),
    HOENN_TO_NATIONAL(SABLEYE2),
    HOENN_TO_NATIONAL(SHARPEDO2),
    HOENN_TO_NATIONAL(PALKIA),
    HOENN_TO_NATIONAL(PIPLUP2),
    HOENN_TO_NATIONAL(KONYA2),
    HOENN_TO_NATIONAL(STUFFUL2),
    HOENN_TO_NATIONAL(LUNALA),
    HOENN_TO_NATIONAL(BUTTERFREE2),
    HOENN_TO_NATIONAL(DIANCIE2),
...
static const u8 sMonFrontAnimIdsTable[NUM_SPECIES - 1] =
{
    ...
    [SPECIES_MTYRANITAR - 1]  = ANIM_V_SHAKE,
    [SPECIES_PIPLUP - 1]      = ANIM_V_JUMPS_SMALL,
    [SPECIES_PRINPLUP - 1]      = ANIM_V_JUMPS_SMALL,
    [SPECIES_EMPOLEON - 1]    = ANIM_V_JUMPS_BIG,
    [SPECIES_BUIZEL - 1]    = ANIM_V_JUMPS_SMALL,
    [SPECIES_FLOATZEL - 1]    = ANIM_V_JUMPS_SMALL,
    [SPECIES_BUNEARY - 1]    = ANIM_V_SQUISH_AND_BOUNCE,
    ...
    [SPECIES_HZOROARK - 1]    = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_HZORUA - 1]    = ANIM_V_SQUISH_AND_BOUNCE,
    ...
    [SPECIES_FLABEBE - 1]    = ANIM_V_SLIDE_WOBBLE,
    [SPECIES_FLOETTE - 1]    = ANIM_V_SLIDE_WOBBLE,	
    [SPECIES_FLORGES - 1]    = ANIM_V_SLIDE_WOBBLE,
    [SPECIES_GOURGEIST - 1]    = ANIM_SHRINK_GROW,
    [SPECIES_PUMPKABOO - 1]    = ANIM_SHRINK_GROW,
    ...
    [SPECIES_TSAREENA - 1]    = ANIM_H_VIBRATE_FASTEST,
    [SPECIES_ALCREMIE - 1]    = ANIM_H_VIBRATE_FASTEST,
    [SPECIES_APPLETUN - 1]    = ANIM_V_SHAKE_LOW_TWICE_FAST,
    [SPECIES_APPLIN - 1]    = ANIM_H_REPEATED_SPRING,
    [SPECIES_GROOKI - 1]    = ANIM_H_REPEATED_SPRING,
    [SPECIES_HATENNA - 1]    = ANIM_V_JUMPS_SMALL,
    [SPECIES_HATTERENE - 1]    = ANIM_H_VIBRATE_FASTEST,	
    [SPECIES_HATTREM - 1]    = ANIM_SHRINK_GROW_FAST,
    [SPECIES_INDEEDEE1 - 1]    = ANIM_ZIGZAG_SLOW,
    [SPECIES_INDEEDEE2 - 1]    = ANIM_ZIGZAG_SLOW,
    [SPECIES_MORPEKO - 1]    = ANIM_TIP_HOP_FORWARD,
    [SPECIES_SCORBUNNY - 1]    = ANIM_TIP_HOP_FORWARD,
    [SPECIES_SOBBLE - 1]    = ANIM_TIP_HOP_FORWARD,
    [SPECIES_WOOLOO - 1]    = ANIM_TUMBLING_FRONT_FLIP_TWICE,
    [SPECIES_YAMPER - 1]    = ANIM_H_SPRING_FAST,
    [SPECIES_JIGGLYTUFF - 1]    = ANIM_GLOW_PURPLE,			
    [SPECIES_CLODSIRE - 1]    = ANIM_H_SLIDE,
    [SPECIES_DACSHBUN - 1]    = ANIM_H_SPRING_FAST,
    [SPECIES_FIDOUGH - 1]    = ANIM_H_SPRING_FAST,
    [SPECIES_FUECOCO - 1]    = ANIM_BACK_FLIP,
    [SPECIES_GALVANADE - 1]    = ANIM_FIGURE_8,
    [SPECIES_MAUSHOLD - 1]    = ANIM_RAPID_H_HOPS,
    [SPECIES_PAWMI - 1]    = ANIM_SPIN,
    [SPECIES_PAWMO - 1]    = ANIM_VIBRATE_TO_CORNERS,
    [SPECIES_PAWMOT - 1]    = ANIM_VIBRATE_TO_CORNERS,	
    [SPECIES_ORICORIO1 - 1]    = ANIM_CONCAVE_ARC_SMALL,
    [SPECIES_ORICORIO2 - 1]    = ANIM_CONCAVE_ARC_SMALL,
    [SPECIES_ORICORIO3 - 1]    = ANIM_CONCAVE_ARC_SMALL,
    [SPECIES_SPRIGATITO - 1]    = ANIM_H_VIBRATE_FASTEST,
    [SPECIES_TANDEMAUS - 1]    = ANIM_RAPID_H_HOPS,
    [SPECIES_TINKATON - 1]    = ANIM_H_VIBRATE_FASTEST,
    [SPECIES_VOLCRYPTID - 1]    = ANIM_SHAKE_FLASH_YELLOW,
    [SPECIES_BLUBBY - 1]    = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_NAVI - 1]    = ANIM_V_SQUISH_AND_BOUNCE,	
    [SPECIES_BASTIODON - 1]    = ANIM_V_SHAKE_TWICE_SLOW,
    [SPECIES_BAXCALIBUR - 1]    = ANIM_CIRCULAR_VIBRATE,
    [SPECIES_BISHARP - 1]    = ANIM_H_VIBRATE,
    [SPECIES_BLITZLE - 1]    = ANIM_H_VIBRATE_FASTEST,
    [SPECIES_CERULEDGE - 1]    = ANIM_V_SHAKE_LOW_TWICE_SLOW,
    [SPECIES_CHANDELURE - 1]    = ANIM_TRIANGLE_DOWN_TWICE,
    [SPECIES_CROAGUNK - 1]    = ANIM_SHRINK_GROW_FAST,
    [SPECIES_EELEKTRIK - 1]    = ANIM_CONVEX_DOUBLE_ARC,
    [SPECIES_EELEKTROSS - 1]    = ANIM_CONCAVE_ARC_LARGE_TWICE,
    [SPECIES_EXCADRILL - 1]    = ANIM_CIRCLE_C_CLOCKWISE_LONG,
    [SPECIES_FROSSLASS - 1]    = ANIM_CONCAVE_ARC_SMALL_SLOW,
    [SPECIES_GHOLDENGO - 1]    = ANIM_H_DIP,
    [SPECIES_GOLETT - 1]    = ANIM_V_STRETCH_BOTH_ENDS,
    [SPECIES_GOLURK - 1]    = ANIM_V_STRETCH_BOTH_ENDS,
    [SPECIES_GOUGING - 1]    = ANIM_SHAKE_GLOW_RED,
    [SPECIES_HANKAMO_O - 1]    = ANIM_H_VIBRATE_FASTEST,
    [SPECIES_HONCHKROW - 1]    = ANIM_SPRING_RISING,
    [SPECIES_JANGMO_O - 1]    = ANIM_V_SLIDE_WOBBLE_SMALL,
    ...
    [SPECIES_AMPHAROS2 - 1]    = ANIM_SHAKE_GLOW_RED_FAST,	
    [SPECIES_SCIZOR2 - 1]    = ANIM_V_SQUISH_AND_BOUNCE,	
    [SPECIES_NICKIT - 1]    = ANIM_V_SQUISH_AND_BOUNCE,	
    [SPECIES_MEOWTH2 - 1]    = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_NINETAILS2 - 1]    = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_PURRLOIN - 1]    = ANIM_GROW_VIBRATE,
    [SPECIES_ROTOM1 - 1]    = ANIM_GLOW_YELLOW,
    [SPECIES_ROTOM2 - 1]    = ANIM_H_SLIDE_WOBBLE,
    [SPECIES_ROTOM3 - 1]    = ANIM_H_STRETCH,
    [SPECIES_ROTOM4 - 1]    = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_ROTOM5 - 1]    = ANIM_TIP_MOVE_FORWARD,
    [SPECIES_ROTOM6 - 1]    = ANIM_V_JUMPS_SMALL,
    [SPECIES_ANNIHILAPE - 1]    = ANIM_SHAKE_GLOW_RED_FAST,
    [SPECIES_ARCANINE2 - 1]    = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_ARMAROUGE - 1]    = ANIM_JOLT_RIGHT_FAST,
    [SPECIES_CARKOL - 1]    = ANIM_GROW_STUTTER_SLOW,
    [SPECIES_COALOSSAL - 1]    = ANIM_V_SHAKE_LOW_TWICE_SLOW,
    [SPECIES_DRAGAPULT - 1]    = ANIM_CONVEX_DOUBLE_ARC_TWICE,
    [SPECIES_DUSKNOIR - 1]    = ANIM_V_STRETCH_BOTH_ENDS_SLOW,
    [SPECIES_GIMMIGHOUL - 1]    = ANIM_BOUNCE_ROTATE_TO_SIDES_SLOW,
    [SPECIES_GIRATINA - 1]    = ANIM_GROW_VIBRATE,
    [SPECIES_HOOPA - 1]    = ANIM_ZIGZAG_SLOW,
    [SPECIES_HOOPA2 - 1]    = ANIM_GROW_IN_STAGES,
    ...
    [SPECIES_SANDSHREW1 - 1]    = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_SANDSLASH1 - 1]    = ANIM_V_SQUISH_AND_BOUNCE,
    ...
    [SPECIES_TAUROS2 - 1]    = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_TERRAKION - 1]    = ANIM_V_SHAKE_TWICE,
    [SPECIES_THIEVUL - 1]    = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_TOXTRICITY2 - 1]    = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_THROH - 1]    = ANIM_GROW_VIBRATE,
    [SPECIES_TING_LU - 1]    = ANIM_SHAKE_GLOW_GREEN,
    ...
    [SPECIES_TOXTRICITY - 1]    = ANIM_H_VIBRATE_FASTEST,
    [SPECIES_URSALUNA - 1]    = ANIM_SHRINK_GROW_VIBRATE,
    [SPECIES_URSALUNA2 - 1]    = ANIM_SHRINK_GROW_VIBRATE,
    [SPECIES_VANILLISH - 1]    = ANIM_H_SLIDE,
    [SPECIES_VANILLITE - 1]    = ANIM_GROW_VIBRATE,
    [SPECIES_VANILLUXE - 1]    = ANIM_GROW_VIBRATE,
    [SPECIES_VOLCANION - 1]    = ANIM_V_SHAKE_TWICE,
    [SPECIES_VULPIX1 - 1]    = ANIM_V_SQUISH_AND_BOUNCE,
    ...
    [SPECIES_HIPPOWDON - 1]    = ANIM_V_STRETCH,
    [SPECIES_DONDOZO - 1]    = ANIM_V_SLIDE_WOBBLE,
    [SPECIES_VESPIQUEEN - 1]    = ANIM_V_SLIDE_WOBBLE,
    ...
    [SPECIES_FROSMOTH - 1]    = ANIM_H_SLIDE_WOBBLE,
    [SPECIES_ORBEETLE - 1]    = ANIM_GROW_TWICE,
    [SPECIES_SINISTEA - 1]    = ANIM_FLICKER_INCREASING,
    [SPECIES_POLTEAGEIST - 1]    = ANIM_FLICKER_INCREASING,
    [SPECIES_MAGNEZONE - 1]    = ANIM_H_SLIDE_WOBBLE,
    [SPECIES_HEATRAN - 1]    = ANIM_GLOW_ORANGE,
    [SPECIES_GREATTUSK - 1]    = ANIM_SPIN_LONG,
    [SPECIES_IRONTREADS - 1]    = ANIM_SPIN_LONG,
    [SPECIES_GLACEON - 1]    = ANIM_V_STRETCH,
    [SPECIES_FEZANDIPITI - 1]    = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_GENGAR2 - 1]    = ANIM_GROW_IN_STAGES,
    [SPECIES_VENUSAUR2 - 1]    = ANIM_GROW_IN_STAGES,
    [SPECIES_PECHARUNT - 1]    = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_GOLEM2 - 1]    = ANIM_V_SHAKE,
    [SPECIES_IRONTHORNS - 1]    = ANIM_SHAKE_GLOW_GREEN,
    [SPECIES_AERODACTYL2 - 1]    = ANIM_V_SLIDE_SLOW,
    [SPECIES_ARCHALUDON - 1]    = ANIM_V_SHAKE,
    [SPECIES_CELESTEELA - 1]    = ANIM_V_SHAKE,
    [SPECIES_NECROZMADUSK - 1]    = ANIM_GLOW_BLACK,
    [SPECIES_REVAVROOM - 1]    = ANIM_JOLT_RIGHT_FAST,
    [SPECIES_SOLGALEO - 1]    = ANIM_H_VIBRATE_FASTEST,
    [SPECIES_VAROOM - 1]    = ANIM_JOLT_RIGHT,
    [SPECIES_TOXICROAK - 1]    = ANIM_H_VIBRATE_FASTEST,
    [SPECIES_COFAGRIGUS - 1]    = ANIM_GLOW_BLACK,
    [SPECIES_ELEBABY - 1]    = ANIM_GLOW_YELLOW,
    [SPECIES_ZAPDOS2 - 1]    = ANIM_FLASH_YELLOW,
    [SPECIES_KONYA - 1]    = ANIM_H_STRETCH,
    ...
    [SPECIES_TOUCANNON - 1]    = ANIM_SHAKE_GLOW_RED,
    ...
    [SPECIES_CORSOLA2 - 1]    = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_MANDIBUZZ - 1]    = ANIM_V_STRETCH,
    [SPECIES_STAKATAKA - 1]    = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_DRAGALGE - 1]    = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_TOXAPEX - 1]    = ANIM_SHAKE_GLOW_RED,
    [SPECIES_DHELMISE - 1]    = ANIM_SWING_CONVEX,
    [SPECIES_CURSOLA - 1]    = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_ARAQUANID - 1]    = ANIM_H_SHAKE,
    [SPECIES_SIRFETCH - 1]    = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_NOIVERN - 1]    = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_CLAWITZER - 1]    = ANIM_H_VIBRATE_FASTEST,
    [SPECIES_GALLADE - 1]    = ANIM_JOLT_RIGHT,
    [SPECIES_LILLIGANT2 - 1]    = ANIM_JOLT_RIGHT,
    [SPECIES_WYRDEER - 1]    = ANIM_H_SHAKE,
    [SPECIES_MISMAGIUS - 1]    = ANIM_H_SHAKE,
    [SPECIES_GOTHITELLE - 1]    = ANIM_H_SHAKE,
    [SPECIES_AVALUGG - 1]    = ANIM_H_SHAKE,
    [SPECIES_DUGTRIO2 - 1]    = ANIM_H_VIBRATE_FASTEST,
    [SPECIES_BLACEPHALON - 1]    = ANIM_H_VIBRATE_FASTEST,
    [SPECIES_FERROSEED - 1]    = ANIM_H_VIBRATE_FASTEST,
    [SPECIES_FERROTHORN - 1]    = ANIM_H_VIBRATE_FASTEST,
    [SPECIES_GLISCOR - 1]    = ANIM_H_VIBRATE_FASTEST,
    [SPECIES_LUGIA2 - 1]    = ANIM_GROW_IN_STAGES,
    [SPECIES_NIHILEGO - 1]    = ANIM_H_VIBRATE_FASTEST,
    [SPECIES_TOGEKISS - 1]    = ANIM_H_VIBRATE_FASTEST,
    [SPECIES_TYPHLOSION2 - 1]    = ANIM_H_VIBRATE_FASTEST,
    [SPECIES_XURKITREE - 1]    = ANIM_GROW_STUTTER_SLOW,
    [SPECIES_DIALGA - 1]    = ANIM_H_SHAKE,
    [SPECIES_ALTARIA2 - 1]    = ANIM_V_STRETCH,
    [SPECIES_BLASTOISE2 - 1]    = ANIM_V_SHAKE_TWICE,
    [SPECIES_SCEPTILE2 - 1]    = ANIM_V_SHAKE,
    [SPECIES_SWAMPERT2 - 1]    = ANIM_H_SHAKE,
    [SPECIES_WALKINGWAKE - 1]    = ANIM_GLOW_BLUE,
    [SPECIES_RAGINGBOLT - 1]    = ANIM_GLOW_YELLOW,
    [SPECIES_ABSOL2 - 1]    = ANIM_CIRCULAR_VIBRATE,
    [SPECIES_AGGRON2 - 1]    = ANIM_V_SHAKE_TWICE,
    [SPECIES_CHARIZARDY - 1]    = ANIM_V_SHAKE,
    [SPECIES_GARDEVOIR2 - 1]    = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_HOUNDOOM2 - 1]    = ANIM_V_SHAKE,
    [SPECIES_LUCARIO2 - 1]    = ANIM_V_STRETCH,
    ...
    [SPECIES_PIPLUP2 - 1]    = ANIM_V_JUMPS_SMALL,
    [SPECIES_KONYA2 - 1]    = ANIM_H_STRETCH,
    [SPECIES_STUFFUL2 - 1]    = ANIM_V_SHAKE,
    [SPECIES_LUNALA - 1]    = ANIM_H_VIBRATE_FASTEST,
    [SPECIES_BUTTERFREE2 - 1]    = ANIM_H_SLIDE_WOBBLE,
    [SPECIES_DIANCIE2 - 1]    = ANIM_V_SQUISH_AND_BOUNCE,
};
...
s32 CalculateBaseDamage(struct BattlePokemon *attacker, struct BattlePokemon *defender, u32 move, u16 sideStatus, u16 powerOverride, u8 typeOverride, u8 battlerIdAtk, u8 battlerIdDef)
{
    ...
    if (type == TYPE_BUG && attacker->ability == ABILITY_SWARM && attacker->hp <= (attacker->maxHP / 3))
        gBattleMovePower = (150 * gBattleMovePower) / 100;
    if (type == TYPE_ICE && attacker->ability == ABILITY_REFRIGERATE && attacker->hp <= (attacker->maxHP))
