...
static const u8 sSpeciesToBackAnimSet[] =
{
    ...
    [SPECIES_MTYRANITAR]   = BACK_ANIM_CONVEX_DOUBLE_ARC,
    [SPECIES_PIPLUP]   = BACK_ANIM_CONCAVE_ARC_SMALL,
    [SPECIES_PRINPLUP]   = BACK_ANIM_CONCAVE_ARC_SMALL,
    [SPECIES_EMPOLEON]   = BACK_ANIM_CONCAVE_ARC_SMALL,
    [SPECIES_BUIZEL]   = BACK_ANIM_CONCAVE_ARC_SMALL,
    [SPECIES_FLOATZEL]   = BACK_ANIM_CONCAVE_ARC_SMALL,
    [SPECIES_BUNEARY]   = BACK_ANIM_V_SHAKE,
    [SPECIES_DRAGALGE]   = BACK_ANIM_V_SHAKE,
