...
const u8 gTypeEffectiveness[381] =
{
    ...
    TYPE_FAIRY, TYPE_ICE, TYPE_MUL_NOT_EFFECTIVE,
...
const struct TrainerMoney gTrainerMoneyTable[] =
{
    ...
    {TRAINER_CLASS_HIDEO, 15},
    {TRAINER_CLASS_FOREIGN_SPY, 70},
    {TRAINER_CLASS_TYRANT, 70},
    {TRAINER_CLASS_GRAV_MASTER, 70},
                                                                        ...
                                                                        | BATTLE_TYPE_TRAINER_HILL)))
    {
        ...
        for (i = 0; i < monsCount; i++)
        {
            ...
            case 0:
            {
                ...
                CreateMon(&party[i], partyData[i].species, partyData[i].lvl, fixedIV, TRUE, personalityValue, -1, 0);
                break;
            }
...
u8 GetWhoStrikesFirst(u8 battler1, u8 battler2, bool8 ignoreChosenMoves)
{
    ...
    // badge boost
    if (!(gBattleTypeFlags & (BATTLE_TYPE_RECORDED_LINK | BATTLE_TYPE_FRONTIER))
