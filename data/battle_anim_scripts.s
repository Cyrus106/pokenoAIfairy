...
Move_DRACO_METEOR:
	...
	createvisualtask AnimTask_BlendParticle, 5, ANIM_TAG_WATER_GUN, 0, 10, 10, 0x3006 @;Purple
	monbg ANIM_TARGET
	setalpha 12, 8
	waitforvisualfinish
...
Move_DRAIN_PUNCH:
	...
	monbg ANIM_ATK_PARTNER
	createvisualtask AnimTask_GetAttackerSide, 2
	jumprettrue DrainPunchAgainstPlayer
	fadetobg BG_HIGHSPEED_OPPONENT
DrainPunchContinue:
	waitbgfadeout
	createvisualtask AnimTask_StartSlidingBg, 5, -2304, 0, 1, -1
...
DrainPunchAgainstPlayer:
	fadetobg BG_HIGHSPEED_PLAYER
	goto DrainPunchContinue
...
Move_DARK_PULSE:
	...
	splitbgprio ANIM_TARGET
	playsewithpan SE_M_SAND_ATTACK, SOUND_PAN_TARGET
	createsprite gSimplePaletteBlendSpriteTemplate, ANIM_ATTACKER, 2, F_PAL_BG, 0, 0, 7, RGB(0, 0, 0)
	delay 10
...
Move_BLOOD_MOON:
	...
	playsewithpan SE_M_MOONLIGHT, 0
	delay 10
	createsprite gMoonlightSparkleSpriteTemplate, ANIM_ATTACK, 40, -12, 0
	delay 10
	createsprite gMoonlightSparkleSpriteTemplate, ANIM_ATTACKER, 40, -24, 0
	delay 10
	createsprite gMoonlightSparkleSpriteTemplate, ANIM_ATTACKER, 40, 21, 0
...
Move_ICICLE_CRASH:
	...
	monbg ANIM_DEF_PARTNER
	createvisualtask AnimTask_GetAttackerSide, 2
	jumprettrue IcicleCrashAgainstPlayer
	fadetobg BG_HIGHSPEED_OPPONENT
IcicleCrashContinue:
	waitbgfadeout
	createvisualtask AnimTask_StartSlidingBg, 5, -2304, 0, 1, -1
...
IcicleCrashIceCrystals:
	...
	delay 3
	return
IcicleCrashAgainstPlayer:
	fadetobg BG_HIGHSPEED_PLAYER
	goto IcicleCrashContinue
...
Move_BULLET_PUNCH:
	...
	monbg ANIM_ATK_PARTNER
	createvisualtask AnimTask_GetAttackerSide, 2
	jumprettrue BulletPunchAgainstPlayer
	fadetobg BG_HIGHSPEED_OPPONENT
BulletPunchContinue:
	waitbgfadeout
	createvisualtask AnimTask_StartSlidingBg, 5, -2304, 0, 1, -1
...
BulletPunchAgainstPlayer:
	fadetobg BG_HIGHSPEED_PLAYER
	goto BulletPunchContinue
...
Move_OMINOUS_WIND:
	...
	createvisualtask AnimTask_BlendBattleAnimPalExclude, 10, ANIM_TARGET, 0, 0, 4, RGB_BLACK
	createvisualtask AnimTask_GetTargetSide, 2
	jumprettrue OminousWindOnPlayer
	fadetobg BG_BUG_OPPONENT
	waitbgfadeout
	createvisualtask AnimTask_StartSlidingBg, 5, 1536, 0, 0, -1
OminousWindContinue:
...
Move_PHANTOM_FORCE:
	loadspritegfx ANIM_TAG_ROUND_SHADOW
	loadspritegfx ANIM_TAG_IMPACT
	choosetwoturnanim PhanSetUp, PhanUnleash
PhanEnd:
	waitforvisualfinish
	end
...
SetHighSpeedBg2:
	createvisualtask AnimTask_GetAttackerSide, 2
	jumprettrue SetHighSpeedBgPlayer2
	fadetobg BG_HIGHSPEED_OPPONENT
	goto SetHighSpeedBgFade2
SetHighSpeedBgPlayer2:
	fadetobg BG_HIGHSPEED_PLAYER
SetHighSpeedBgFade2:
	waitbgfadeout
	createvisualtask AnimTask_StartSlidingBg, 5, -2304, 0, 1, -1
...
Move_FORCE_PALM:
	...
	monbg ANIM_ATK_PARTNER
	createvisualtask AnimTask_GetAttackerSide, 2
	jumprettrue ForcePalmAgainstPlayer
	fadetobg BG_HIGHSPEED_OPPONENT
ForcePalmContinue:
	waitbgfadeout
	createvisualtask AnimTask_StartSlidingBg, 5, -2304, 0, 1, -1
...
Move_BULLET_PUNCH_2:
	...
	monbg ANIM_ATK_PARTNER
	createvisualtask AnimTask_GetAttackerSide, 2
	jumprettrue BulletPunchAgainstPlayer2
	fadetobg BG_HIGHSPEED_OPPONENT
BulletPunchContinue2:
	waitbgfadeout
	createvisualtask AnimTask_StartSlidingBg, 5, -2304, 0, 1, -1
	waitbgfadein
	delay 0
...
BulletPunchAgainstPlayer2:
	fadetobg BG_HIGHSPEED_PLAYER
	goto BulletPunchContinue2
...
Move_SUNSTEEL_STRIKE:
	...
	playsewithpan SE_M_MOONLIGHT, 0
	delay 10
	createsprite gSunlightRaySpriteTemplate, ANIM_ATTACK, 40, -12, 0
	delay 10
	createsprite gSunlightRaySpriteTemplate, ANIM_ATTACKER, 40, -24, 0
	delay 10
	createsprite gSunlightRaySpriteTemplate, ANIM_ATTACKER, 40, 21, 0
	delay 10
	createsprite gSunlightRaySpriteTemplate, ANIM_ATTACKER, 40, 0, 0
	delay 30
	createsprite gSunlightRaySpriteTemplate, ANIM_ATTACKER, 40, 10, 0
	delay 20
	createvisualtask AnimTask_MoonlightEndFade, 2
	waitforvisualfinish
	fadetobg BG_DARK
