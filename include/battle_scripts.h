...
extern const u8 BattleScript_LocalTwoTrainersDefeatedLink[];
extern const u8 BattleScript_LocalBattleWonLoseTexts[];
extern const u8 BattleScript_LocalBattleWonLoseTextsLink[];
extern const u8 BattleScript_LocalBattleWonReward[];
extern const u8 BattleScript_LocalBattleWonRewardLink[];
...
extern const u8 BattleScript_LinkBattleWon[];
...
extern const u8 BattleScript_DefandSpDefDown[];
